 ...
 */
@Local
public interface RequestPropertyServiceLocal {
    ...
    public RequestsForPropertyViewing saveRequestsForPropertyViewing(RequestsForPropertyViewing request,Property requestedProperty,User userFromSesion);
